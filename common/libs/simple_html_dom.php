...
class simple_html_dom
{
    ...
    function clear()
    {
        if(isset($this->nodes) && is_array($this->nodes)) foreach ($this->nodes as $n) {$n->clear(); $n = null;}
        // This add next line is documented in the sourceforge repository. 2977248 as a fix for ongoing memory leaks that occur even with the use of clear.
        if (isset($this->children) && is_array($this->children)) foreach ($this->children as $n) {$n->clear(); $n = null;}
